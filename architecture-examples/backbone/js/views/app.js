// Using the element controller pattern
// Views to create AppView, TodoView
// AppView : The whole apps view
// TodoView : Creates a single todo
...
app.AppView = Backbone.View.extend({
	...
	render: function(){
		...
		if ( app.Todos.length ){
			...
			this.$footer.html(this.statesTemplate({
				completed: completed,
				remaining: remaining
			}));
